...
function JobItem({
  ...
  return (
    <li>
      ...
      <a
        className="group/item transition-[background-color, opacity]  grid items-baseline rounded-md duration-500 hover:duration-[250ms] sm:grid-cols-10  sm:gap-8 md:gap-4 lg:p-4 lg:hover:bg-primary-900/40 lg:hover:!opacity-100 lg:hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:hover:drop-shadow-lg lg:group-hover/list:opacity-50"
        href={companyUri}
